...
const MovieList = ({movielist}) => {
    ...
    return (
        <div> 
            <div className="d-flex justify-content-around mt-3" style={{width:"50%"}}>
            <Form.Control type="text" placeholder="enter a name of film " className="col-md-7" onChange={handlesearch} />
             <div>
